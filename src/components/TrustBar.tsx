...
export const TrustBar = () => {
  ...
  return (
    <div className="bg-charcoal border-y border-white/5 py-6 overflow-hidden relative">
        ...
        >
          {duplicatedFeatures.map((feature, index) => (
            <div key={index} className="flex items-center space-x-4 shrink-0 group">
              <div className="p-2.5 rounded-full bg-white/5 group-hover:bg-gold/10 transition-colors border border-white/5">
